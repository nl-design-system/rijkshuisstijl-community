    ...
    return (
        ...
        <Heading appearanceLevel={2} level={2}>
          ...
          <Paragraph className='paragraph__padding'>
            Klaar om er direct van start te gaan? Hieronder vind je de README's van de beschikbare tools en frameworks. Voor een dieper begrip en uitgebreide documentatie verwijzen we je graag naar de "lees en leer" section.
          </Paragraph>
