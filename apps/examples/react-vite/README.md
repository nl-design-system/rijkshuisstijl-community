...
Error Prevention:
If a change in the core components breaks the layout or functionality in this app, the CI pipeline will fail. This prevents broken versions from being released to our consumers.
