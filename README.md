...
In dit project wordt Node.js versie **_24_** gebruikt. Dit project bevat een [.nvmrc](.nvmrc) bestand en helpt je met het
...
| Package                                                                                                                                      | Purpose                                                                                                                                                                                                                                                                                       |
| :------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [components-css](https://github.com/nl-design-system/rijkshuisstijl-community/blob/main/packages/components-css/library-css/README.md)       | Hier kunnen CSS-componenten toegevoegd worden die nog niet bestaan in de NL Design System-community.                                                                                                                                                                                          |
| [components-react](https://github.com/nl-design-system/rijkshuisstijl-community/blob/main/packages/components-react/library-react/README.md) | Optioneel voor het toevoegen van een React-wrapper aan een CSS-component als die nog niet bestaat.                                                                                                                                                                                            |
...
Vanuit`packages/components-react/library-react` krijg je een gedetailleerder overzicht van tests:
