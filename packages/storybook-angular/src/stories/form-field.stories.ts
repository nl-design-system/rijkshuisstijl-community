...
const meta: Meta<FormFieldComponent> = {
  ...
  render: ({ invalid, type, showLabel, showInput, showDescription }) => ({
    ...
    <rhc-form-field
      ...
      >
        <input rhc-input class="utrecht-textbox utrecht-textbox--html-input" />
        <rhc-paragraph rhc-error-message>Foutmelding...</rhc-paragraph>
        <label rhc-form-label class="utrecht-form-label">Label...</label>
        <rhc-paragraph rhc-description class="utrecht-form-field-description">Beschrijving...</rhc-paragraph>
    </rhc-form-field>
    `,
    props: {
      type,
