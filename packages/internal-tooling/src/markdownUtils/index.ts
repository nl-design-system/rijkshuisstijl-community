 ...
 * punctuation (including hyphens and underscores), or at the start/end of the string. The replacement is case-insensitive
 * by default and global, meaning it will replace all instances of the target in the text.
 *
 * Use cases:
