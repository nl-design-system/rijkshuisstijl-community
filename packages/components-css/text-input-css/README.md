...
Dit is het Text Input CSS component van het Rijkshuisstijl Community Design System[<https://github.com/nl-design-system/rijkshuisstijl-community/>]. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/text-input-css
```
