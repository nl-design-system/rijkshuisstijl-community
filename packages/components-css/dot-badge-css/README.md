...
<span class="rhc-dot-badge" role="status">
  <span class="rhc-dot-badge__sr-only" data-testid="rhc-dot-badge__sr-label"> Nieuw bericht </span>
  <svg />
</span>
```
