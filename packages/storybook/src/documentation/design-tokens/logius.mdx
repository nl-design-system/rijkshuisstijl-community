...
<Meta title="Rijkshuisstijl Community/Design Tokens/Logius Thema" />

# Thema installeren

Hieronder vind je instructies hoe je het Logius thema in je project kan toepassen.
...
pakket, en omring het deel van je applicatie waar je het thema wilt toepassen. Het Logius-thema is: `logius-theme`.
