...
export default function Page() {
    ...
    <PageLayoutTwoColumnSidenav>
      ...
      >
        ...
        <Paragraph purpose="lead">
          Met design tokens kun je veel sneller voldoen aan de huisstijl, omdat alle mogelijke opties al beschikbaar
          zijn gemaakt in handige bestandjes voor developers en designers.
        </Paragraph>
        <Paragraph>
          Vroeger was een huisstijlgids de bron om kleurcodes te kopiëren. De nieuwe werkwijze is: vind de juiste
          design token, en koppel die in je design en code.
        </Paragraph>
        <Paragraph>
          <Paragraph>
            Groot voordeel: het design kan zich dan automatisch aanpassen, door een extra set design tokens.
            Bijvoorbeeld kleuren voor dark mode. Of fluid design, met kleine letters en compactere layout voor kleine
            schermen, en grote letters en een ruime layout voor groter schermen.
          </Paragraph>
          <Paragraph>
            Ook handig: er zijn regelmatig updates aan de design tokens, en de designs kunnen dan zonder veel moeite de
            verbeteringen toepassen.
          </Paragraph>
          <Heading level={2}>Code</Heading>
          In CSS gebruik je design tokens door een CSS variable te gebruiken in plaats van een gekopieerde waarde. Door
          de voorspelbare namen in het design system, is het vaak ook makkelijker in gebruik. Bijvoorbeeld:
        </Paragraph>
        <CodeBlock>
          {`.example-card {
  ...
  padding: var(--rhc-space-3xl);
        ...
        <Paragraph>
          De waarde van elke design token wordt aangeleverd in een CSS-bestand van het design system. Een prototype met
          HTML, ziet er bijvoorbeeld zo uit:
        </Paragraph>
        <CodeBlock>
          {`<!DOCTYPE html>
<html class="rhc-theme" lang="en" dir="ltr">
  ...
  <body>
    <div class="example-card">Hello, world!</div>
        ...
        <Paragraph>
          Installeer de laatste versie van design tokens in je project met npm of pnpm. Op deze manier kun je ook
          makkelijk updaten naar nieuwe versies:
        </Paragraph>
        ...
        <Paragraph>
          Lees het{' '}
          <Link href="https://nldesignsystem.nl/handboek/designer/figma-stappenplan/">Figma Stappenplan</Link> bij NL
          Design System over hoe je in het algemeen de Figma bibliotheek koppelt aan design tokens. Op deze manier kun
          je ook de{' '}
