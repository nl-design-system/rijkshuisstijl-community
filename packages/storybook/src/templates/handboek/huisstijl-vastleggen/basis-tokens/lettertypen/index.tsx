      ...
      <div className="rhc-margin-block-end-wrapper">
        ...
        <DesignTokenTable>
          {[
            ...
            <DesignTokenRow key={name} path={['rhc', 'text', 'font-size', name]}>
              <FontSample
        ...
        <DesignTokenTable>
          {Object.entries(tokens['rhc']['text']['line-height'])
            ...
            .map(([name, value]) => (
              <DesignTokenRow key={name} path={['rhc', 'text', 'line-height', name]}>
                <LineHeightSample
                  fontFamily={tokens['rhc']['text']['font-family']['sans']}
        ...
        <DesignTokenTable>
          {[
            ...
            <DesignTokenRow key={name} path={['rhc', 'text', 'font-weight', name]}>
              <FontSample
                className="rhc-font-sample--table-cell"
                fontFamily={tokens['rhc']['text']['font-family']['sans']}
