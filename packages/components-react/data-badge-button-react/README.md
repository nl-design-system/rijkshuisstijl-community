...
Dit is de Data Badge Button React Component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/data-badge-button-react
```

## Gebruik

Op de storybook voor Data Badge Button React Component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-data-badge-button--docs]
