...
Dit is de Radio Group React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/radio-group-react
```

## Gebruik

Op de storybook voor Radio Group React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-radio-group--docs]
