...
Dit is de Textarea React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/textarea-react
```

## Gebruik

Op de storybook voor Textarea React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-textarea--docs]
