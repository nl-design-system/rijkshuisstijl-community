...
Dit is de Message List Item React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/message-list-item-react
```

## Gebruik

Op de storybook voor Message List Item React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-message-list--docs]
