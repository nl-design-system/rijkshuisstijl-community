...
Dit package bevat de specifieke code voor het component. Als je alle rijkshuisstijl community componenten wil kijk dan naar [https://github.com/nl-design-system/rijkshuisstijl-community/blob/main/packages/components-react/README.md]. Voor verdere informatie over het inzet van de component kijk naar onze documentatie [https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-data-badge--docs]

## Installatie

```bash
pnpm add @rijkshuisstijl-community/data-badge-react
```

## Gebruik

Dit component is te gebruiken door de DataBadge te importeren. De component heeft één (verplichte) property genaamd label. De tekst die hierin wordt gezet is alleen zichtbaar voor screen readers.

```tsx
<DataBadge label="tekst" />
```
