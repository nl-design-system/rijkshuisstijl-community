...
Dit is de Pre Heading React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/pre-heading-react
```

## Gebruik

Op de storybook voor Pre Heading React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-pre-heading--docs]
