...
Dit is de Listbox React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/listbox-react
```

## Gebruik

Op de storybook voor Listbox React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-listbox--docs]
