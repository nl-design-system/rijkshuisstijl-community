...
Dit is de Page Number Navigation React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/page-number-navigation-react
```

## Gebruik

Op de storybook voor Page Number Navigation React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/react-components-page-number-navigation--docs]
