...
Dit is de Fieldset React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/fieldset-react
```

## Gebruik

Op de storybook voor Fieldset React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-fieldset--docs]
