...
Dit is de Expandable Checkbox Group React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/expandable-checkbox-group-react
```

## Gebruik

Op de storybook voor Expandable Checkbox Group React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-expandable-checkbox-group--docs]
