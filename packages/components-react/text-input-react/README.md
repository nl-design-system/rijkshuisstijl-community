...
Dit is de Text Input React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/text-input-react
```

## Gebruik

Op de storybook voor Text Input React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-text-input--docs]
