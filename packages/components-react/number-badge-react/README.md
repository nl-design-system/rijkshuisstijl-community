...
Dit is de Number Badge React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/number-badge-react
```

## Gebruik

Op de storybook voor Number Badge React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-counter-badge--docs]
