...
Dit is de Ordered List React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/ordered-list-react
```

## Gebruik

Op de storybook voor Ordered List React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-ordered-list--docs]
