...
Dit is de Navigation Bar React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/navigation-bar-react
```

## Gebruik

Op de storybook voor Navigation Bar React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-nav-bar--docs]
