...
Dit is de Language Navigation React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/language-navigation-react
```

## Gebruik

Op de storybook voor Language Navigation React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-language-navigation--docs]
