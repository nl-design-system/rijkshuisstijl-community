...
Dit is de Side Navigation Item React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/side-nav-item-react
```
