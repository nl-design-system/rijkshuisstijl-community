...
Dit is de Navigation List React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/navigation-list-react
```

## Gebruik

Op de storybook voor Navigation List React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/react-components-navigation-list--docs]
