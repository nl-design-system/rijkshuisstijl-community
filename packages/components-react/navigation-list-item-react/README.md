...
Dit is de Navigation List Item React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/navigation-list-item-react
```

## Gebruik

Op de storybook voor Navigation List Item React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/react-components-navigation-list-navigation-list-item--docs]
