...
Dit is de Unordered List React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/unordered-list-react
```

## Gebruik

Op de storybook voor Unordered List React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-unordered-list--docs]
