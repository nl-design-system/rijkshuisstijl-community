...
Dit is de Modal Dialog React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/modal-dialog-react
```

## Gebruik

Op de storybook voor Modal Dialog React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/react-components-modal-dialog--docs]
