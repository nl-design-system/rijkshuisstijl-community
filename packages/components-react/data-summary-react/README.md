...
```bash
pnpm add @rijkshuisstijl-community/data-summary--react
```

## Gebruik

Op de storybook voor Data Summary Component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-data-summary--docs]
