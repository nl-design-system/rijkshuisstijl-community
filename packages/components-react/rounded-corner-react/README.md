...
Dit is de Rounded Corner React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/rounded-corner-react
```

## Gebruik

Op de storybook voor Rounded Corner React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-rounded-corner--docs]
