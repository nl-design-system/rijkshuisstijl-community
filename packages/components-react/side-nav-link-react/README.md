...
Dit is de Side Navigation Link React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/side-nav-link-react
```

## Gebruik

Op de storybook voor Side Navigation Link React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-sidenavlink--docs]
