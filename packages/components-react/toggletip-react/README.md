...
Dit is de Toggletip React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/toggletip-react
```

## Gebruik

Op de storybook voor Toggletip React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-toggletip--docs]
