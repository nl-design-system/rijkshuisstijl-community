...
Dit is de Link Button React component van het Rijkshuisstijl Community Design System. Zie ook de volgende Link Buttons:
...
```bash
pnpm add @rijkshuisstijl-community/link-button-react
```

## Gebruik

Op de storybook voor Link Button React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-link-button--docs]
