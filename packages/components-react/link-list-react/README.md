...
Dit is de Link List React component van het Rijkshuisstijl Community Design System. Zie ook de volgende Link Lists:
...
```bash
pnpm add @rijkshuisstijl-community/link-list-react
```

## Gebruik

Op de storybook voor Link List React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-link-list--docs]
