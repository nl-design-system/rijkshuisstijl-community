...
Dit is de Skip Link React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/skip-link-react
```

## Gebruik

Op de storybook voor Skip Link React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rijkshuisstijl-skip-link--docs]
