...
Dit is de Data Summary Item React-component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/data-summary-item--react
```

## Gebruik

Op de storybook voor Data Summary Item Component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/rhc-data-summary-item--docs]
