...
Dit is de File Input React component van het Rijkshuisstijl Community Design System. Zie ook de volgende links:
...
```bash
pnpm add @rijkshuisstijl-community/file-input-react
```

## Gebruik

Op de storybook voor File Input React component staan voorbeelden voor het gebruik van dit component[https://rijkshuisstijl-community.vercel.app/?path=/docs/css-file-input--docs]
