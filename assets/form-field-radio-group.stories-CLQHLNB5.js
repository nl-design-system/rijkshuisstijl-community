import{m as k}from"./mergeMarkdown-B56Gr9e6.js";import{g as D,s as w}from"./index-BPyW9sHl.js";import{r as e}from"./iframe-CYk8V2d0.js";import{r as M}from"./form-field-radio-group-Xot207P0.js";import"./preload-helper-Dp1pzeXC.js";D.define();w.define();const V=({label:S,description:T,errormessage:j,status:F,invalid:i,dir:I,...R})=>e.createElement("rhc-form-radio-group",{label:S,description:T,errormessage:j,status:F,dir:I,invalid:i==null?void 0:i.toString(),...R}),B={title:"Form Field/Form Field Radio Group",id:"rhc-form-field-radio-group-web",component:V,argTypes:{label:{description:"The label of the form field",table:{type:{summary:"string"},defaultValue:{summary:'"Select option"'}}},children:{description:"The options of the select",table:{type:{summary:"ReactNode"},defaultValue:{summary:""}}},errorMessage:{description:"Adds an error message",table:{type:{summary:"string"},defaultValue:{summary:""}}},invalid:{description:"Adds an error message",control:"boolean",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},description:{description:"The description of the form field",table:{type:{summary:"string"},defaultValue:{summary:""}}},dir:{description:"The direction of the input",table:{type:{summary:"string"},defaultValue:{summary:"auto"}}}},args:{dir:"",description:"",errorMessage:""},parameters:{status:{type:"UNSTABLE"},docs:{description:{component:k([M])}},figma:"https://www.figma.com/design/txFX5MGRf4O904dtIFcGTF/NLDS---Rijkshuisstijl---Bibliotheek?node-id=958-1925&node-type=canvas&t=HiNKOQhf1hQtLZrr-0",componentOrigin:"Dit component is volledig ontwikkeld door de Rijkshuisstijl Community.",github:"https://github.com/nl-design-system/rijkshuisstijl-community/blob/main/packages/web-components/src/components/FormFieldRadioGroup.tsx"}},r={args:{label:"Select option",children:[e.createElement("rhc-form-radio",{label:"Option 1",name:"radio-demo",value:"option1"}),e.createElement("rhc-form-radio",{label:"Option 2",name:"radio-demo",value:"option2"}),e.createElement("rhc-form-radio",{label:"Option 3",name:"radio-demo",value:"option3"})]}},a={args:{label:"Select option",children:[e.createElement("rhc-form-radio",{label:"Option 1",name:"radio-demo",value:"option1",inputInvalid:"true"}),e.createElement("rhc-form-radio",{label:"Option 2",name:"radio-demo",value:"option2",inputInvalid:"true"}),e.createElement("rhc-form-radio",{label:"Option 3",name:"radio-demo",value:"option3",inputInvalid:"true"})],errorMessage:"This is an error message",invalid:!0}},o={args:{...r.args,description:"This is a description"}},t={args:{...r.args,status:"This is a status"}},n={args:{label:"حدد خياراً",description:"هذا هو الوصف",status:"هذه هي رسالة الحالة",children:[e.createElement("rhc-form-radio",{label:"خيار 1",name:"radio-demo",value:"option1"}),e.createElement("rhc-form-radio",{label:"خيار 2",name:"radio-demo",value:"option2"}),e.createElement("rhc-form-radio",{label:"خيار 3",name:"radio-demo",value:"option3"})]}};var s,m,l;r.parameters={...r.parameters,docs:{...(s=r.parameters)==null?void 0:s.docs,source:{originalSource:`{
  args: {
    label: 'Select option',
...
} as StoryObj<typeof meta>`,...(O=(E=n.parameters)==null?void 0:E.docs)==null?void 0:O.source}}};const Q=["Default","Invalid","Description","Status","RightToLeft"];export{r as Default,o as Description,a as Invalid,n as RightToLeft,t as Status,Q as __namedExportsOrder,B as default};
