import{j as e,M as i,k as o,T as a}from"./iframe-CQ-PXEy2.js";import{useMDXComponents as d}from"./index-BsX4nJcX.js";import"./preload-helper-Dp1pzeXC.js";const s=`# @rijkshuisstijl-community/design-tokens
...
2. Voeg het nieuwe thema toe in de [storybook preview.tsx](https://github.com/nl-design-system/rijkshuisstijl-community/blob/main/packages/storybook/config/preview.tsx)
   ...
   \`\`\`
`;function r(n){return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Design Tokens/Standaard Thema"}),`
`,e.jsx(o,{children:c}),`
`,e.jsx(a,{children:"Changelog"}),`
`,e.jsx(o,{children:s})]})}function m(n={}){const{wrapper:t}={...d(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(r,{...n})}):r()}export{m as default};
