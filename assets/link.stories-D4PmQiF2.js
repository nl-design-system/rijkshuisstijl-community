import{j as e}from"./jsx-runtime-BlAj40OV.js";import{o as N}from"./index.esm-C4rqqejK.js";import{c as q,I as d}from"./index.esm-ByJjFMhT.js";import{I as B,a as O}from"./IconCalendarEvent-C7weFPm_.js";import"./index-Cs7sjTYM.js";import"./_commonjsHelpers-BosuxZz1.js";/* empty css              */import"./objectWithoutProperties-BJfzkg-c.js";import"./extends-CF3RwP-h.js";const U=`<!-- @license CC0-1.0 -->
...
`,u=({href:V,children:E,iconLeft:P,iconRight:F,external:c,className:H,...M})=>e.jsxs(N,{external:c,href:V,className:q({"utrecht-link--external":c},H),...M,children:[P&&e.jsx(d,{children:e.jsx(B,{})}),E,F&&e.jsx(d,{children:e.jsx(O,{})})]}),re={title:"Rijkshuisstijl/Link",id:"rhc-link",component:u,argTypes:{href:{description:"Url to link to",type:{name:"string",required:!0},table:{category:"Property"}},external:{description:"Whether the link is external",type:{name:"boolean"},table:{category:"Property"}},externalLabel:{description:"SR only label for external link icon",type:{name:"string"},table:{category:"Property"}},children:{description:"Link text - default webcomponent slot",type:{name:"string",required:!0},table:{category:"Webcomponent Slot"},defaultValue:""},iconLeft:{description:"Icon Left",type:{name:"boolean"},table:{category:"Demo"},defaultValue:!1},iconRight:{description:"Icon Right",type:{name:"boolean"},table:{category:"Demo"},defaultValue:!1}},args:{children:""},tags:["autodocs"],parameters:{docs:{description:{component:U}}},render:u},n={args:{href:"#",children:"Label"}},r={args:{href:"#",children:"Label",iconLeft:!0}},t={args:{href:"#",children:"Label",iconRight:!0}},a={args:{href:"#",children:"Label",external:!0,externalLabel:"example external label"}},o={parameters:{pseudo:{active:!0}},args:{href:"#",children:"Label"}},i={parameters:{pseudo:{focus:!0}},args:{href:"#",children:"Label"}},s={parameters:{},args:{href:"#",children:"Label",className:"utrecht-link--focus-visible"}},l={parameters:{pseudo:{visited:!0}},args:{href:"https://example.com/",children:"Label"}};var m,k,p;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    href: '#',
    children: 'Label'
  }
}`,...(p=(k=n.parameters)==null?void 0:k.docs)==null?void 0:p.source}}};var g,b,h;r.parameters={...r.parameters,docs:{...(g=r.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    href: '#',
    children: 'Label',
    iconLeft: true
  }
}`,...(h=(b=r.parameters)==null?void 0:b.docs)==null?void 0:h.source}}};var v,f,w;t.parameters={...t.parameters,docs:{...(v=t.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    href: '#',
    children: 'Label',
    iconRight: true
  }
}`,...(w=(f=t.parameters)==null?void 0:f.docs)==null?void 0:w.source}}};var j,L,x;a.parameters={...a.parameters,docs:{...(j=a.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    href: '#',
    children: 'Label',
    external: true,
...
}`,...(x=(L=a.parameters)==null?void 0:L.docs)==null?void 0:x.source}}};var _,z,A;o.parameters={...o.parameters,docs:{...(_=o.parameters)==null?void 0:_.docs,source:{originalSource:`{
  parameters: {
    pseudo: {
      active: true
    }
...
}`,...(A=(z=o.parameters)==null?void 0:z.docs)==null?void 0:A.source}}};var y,R,G;i.parameters={...i.parameters,docs:{...(y=i.parameters)==null?void 0:y.docs,source:{originalSource:`{
  parameters: {
    pseudo: {
      focus: true
    }
...
}`,...(G=(R=i.parameters)==null?void 0:R.docs)==null?void 0:G.source}}};var C,S,W;s.parameters={...s.parameters,docs:{...(C=s.parameters)==null?void 0:C.docs,source:{originalSource:`{
  parameters: {},
  args: {
    href: '#',
    children: 'Label',
...
}`,...(W=(S=s.parameters)==null?void 0:S.docs)==null?void 0:W.source}}};var I,D,T;l.parameters={...l.parameters,docs:{...(I=l.parameters)==null?void 0:I.docs,source:{originalSource:`{
  parameters: {
    pseudo: {
      visited: true
    }
...
}`,...(T=(D=l.parameters)==null?void 0:D.docs)==null?void 0:T.source}}};const te=["Default","IconLeft","IconRight","External","Active","Focus","FocusVisible","Visited"];export{o as Active,n as Default,a as External,i as Focus,s as FocusVisible,r as IconLeft,t as IconRight,l as Visited,te as __namedExportsOrder,re as default};
