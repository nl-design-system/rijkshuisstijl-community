import{j as e}from"./jsx-runtime-BoFrXSaA.js";import{q as N}from"./index.esm-BHSYHCTf.js";import{c as q,I as d}from"./index.esm-BO76dSMk.js";import{I as B,a as O}from"./IconCalendarEvent-BJenffbc.js";import"./index-WI1YhYyJ.js";import"./_commonjsHelpers-Cpj98o6Y.js";/* empty css              */import"./objectWithoutProperties-BJfzkg-c.js";const U=`<!-- @license CC0-1.0 -->
...
`,u=({href:E,children:V,iconLeft:P,iconRight:F,external:c,className:H,...M})=>e.jsxs(N,{external:c,href:E,className:q({"utrecht-link--external":c},H),...M,children:[P&&e.jsx(d,{children:e.jsx(B,{})}),V,F&&e.jsx(d,{children:e.jsx(O,{})})]}),ne={title:"Rijkshuisstijl/Link",id:"rhc-link",component:u,argTypes:{href:{description:"Url to link to",type:{name:"string",required:!0},table:{category:"Property"}},external:{description:"Whether the link is external",type:{name:"boolean"},table:{category:"Property"}},externalLabel:{description:"SR only label for external link icon",type:{name:"string"},table:{category:"Property"}},children:{description:"Link text - default webcomponent slot",type:{name:"string",required:!0},table:{category:"Webcomponent Slot"},defaultValue:""},iconLeft:{description:"Icon Left",type:{name:"boolean"},table:{category:"Demo"},defaultValue:!1},iconRight:{description:"Icon Right",type:{name:"boolean"},table:{category:"Demo"},defaultValue:!1}},args:{children:""},tags:["autodocs"],parameters:{status:{type:"STABLE"},docs:{description:{component:U}}},render:u},n={args:{href:"#",children:"Label"}},t={args:{href:"#",children:"Label",iconLeft:!0}},r={args:{href:"#",children:"Label",iconRight:!0}},a={args:{href:"#",children:"Label",external:!0,externalLabel:"example external label"}},o={parameters:{pseudo:{active:!0}},args:{href:"#",children:"Label"}},i={parameters:{pseudo:{focus:!0}},args:{href:"#",children:"Label"}},s={parameters:{},args:{href:"#",children:"Label",className:"utrecht-link--focus-visible"}},l={parameters:{pseudo:{visited:!0}},args:{href:"https://example.com/",children:"Label"}};var m,k,p;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    href: '#',
    children: 'Label'
  }
}`,...(p=(k=n.parameters)==null?void 0:k.docs)==null?void 0:p.source}}};var g,b,h;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    href: '#',
    children: 'Label',
    iconLeft: true
  }
}`,...(h=(b=t.parameters)==null?void 0:b.docs)==null?void 0:h.source}}};var v,f,w;r.parameters={...r.parameters,docs:{...(v=r.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    href: '#',
    children: 'Label',
    iconRight: true
  }
}`,...(w=(f=r.parameters)==null?void 0:f.docs)==null?void 0:w.source}}};var j,L,x;a.parameters={...a.parameters,docs:{...(j=a.parameters)==null?void 0:j.docs,source:{originalSource:`{
  args: {
    href: '#',
    children: 'Label',
    external: true,
...
}`,...(D=(T=l.parameters)==null?void 0:T.docs)==null?void 0:D.source}}};const te=["Default","IconLeft","IconRight","External","Active","Focus","FocusVisible","Visited"];export{o as Active,n as Default,a as External,i as Focus,s as FocusVisible,t as IconLeft,r as IconRight,l as Visited,te as __namedExportsOrder,ne as default};
