import{m}from"./merge-markdown-BtgmYwh_.js";import{f as h}from"./index-DqXW3Q7L.js";import"./_commonjsHelpers-C932wzq6.js";import"./objectWithoutProperties-CbCxjZzm.js";import"./index-DAIO8Scy.js";import"./jsx-runtime-CLpGMVip.js";import"./index-Be-aV6DI.js";import"./clsx-B-dksMZM.js";const u=`<!-- @license CC0-1.0 -->
...
`;/* @license CC0-1.0 */const C={title:"Rijkshuisstijl/Paragraph",id:"rhc-paragraph",component:h,argTypes:{lead:{description:"Lead paragraph",type:{name:"boolean"},table:{category:"API"},defaultValue:!1},small:{description:"Small paragraph",type:{name:"boolean"},table:{category:"API"}},children:{description:"Paragraph text - default webcomponent slot",type:{name:"string",required:!0},table:{category:"Webcomponent Slot"},defaultValue:""}},args:{children:""},tags:["autodocs"],parameters:{status:{type:"STABLE"},docs:{description:{component:m([u])}},componentOrigin:"Dit component is overgenomen van de Gemeente Utrecht, met alleen overgeschreven design tokens van de Rijkshuisstijl Community."}},e={args:{children:"Lorem ipsum dolor sit amet, consectetur ad isicing elit, sed do eiusmod"},name:"Paragraph"},n={args:{children:"Lorem ipsum dolor sit amet, consectetur ad isicing elit, sed do eiusmod",lead:!0}},a={args:{children:"Lorem ipsum dolor sit amet, consectetur ad isicing elit, sed do eiusmod",small:!0}};var r,t,o;e.parameters={...e.parameters,docs:{...(r=e.parameters)==null?void 0:r.docs,source:{originalSource:`{
  args: {
    children: 'Lorem ipsum dolor sit amet, consectetur ad isicing elit, sed do eiusmod'
  },
  name: 'Paragraph'
}`,...(o=(t=e.parameters)==null?void 0:t.docs)==null?void 0:o.source}}};var i,s,l;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
    children: 'Lorem ipsum dolor sit amet, consectetur ad isicing elit, sed do eiusmod',
    lead: true
  }
}`,...(l=(s=n.parameters)==null?void 0:s.docs)==null?void 0:l.source}}};var d,g,p;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    children: 'Lorem ipsum dolor sit amet, consectetur ad isicing elit, sed do eiusmod',
    small: true
  }
}`,...(p=(g=a.parameters)==null?void 0:g.docs)==null?void 0:p.source}}};const G=["Default","Lead","Small"];export{e as Default,n as Lead,a as Small,G as __namedExportsOrder,C as default};
