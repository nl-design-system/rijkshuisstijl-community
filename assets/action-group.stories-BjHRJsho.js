import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{B as p,c as e}from"./index-B0wZklxY.js";import"./objectWithoutProperties-BJfzkg-c.js";import"./index-C5EOLjWw.js";import"./_commonjsHelpers-C932wzq6.js";import"./clsx-B-dksMZM.js";const m=`<!-- @license CC0-1.0 -->
...
`,k={title:"Rijkshuisstijl/ActionGroup",id:"rhc-action-group",component:p,argTypes:{direction:{description:"Layout of the action group",control:"select",options:["column","row"]}},tags:["autodocs"],parameters:{status:{type:"STABLE"},docs:{description:{component:m}}}},n={args:{children:[a.jsx(e,{appearance:"primary-action-button",children:"Save and continue"},"primary-action-button"),a.jsx(e,{appearance:"secondary-action-button",children:"Back"},"secondary-action-button")]},name:"Default"},t={args:{direction:"column",children:[a.jsx(e,{appearance:"primary-action-button",children:"Save and continue"},"primary-action-button"),a.jsx(e,{appearance:"secondary-action-button",children:"Back"},"secondary-action-button")]},name:"Column"};var o,r,i;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:`{
  ...
  name: 'Column'
}`,...(u=(s=t.parameters)==null?void 0:s.docs)==null?void 0:u.source}}};const B=["Default","Column"];export{t as Column,n as Default,B as __namedExportsOrder,k as default};
