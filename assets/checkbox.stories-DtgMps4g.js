import{f as Se}from"./index.esm-5Q5QRGti.js";import{r as Fe}from"./checkbox-DFEaw_Dq.js";import{m as Ie}from"./merge-markdown-BtgmYwh_.js";import"./index-DAIO8Scy.js";import"./_commonjsHelpers-C932wzq6.js";import"./jsx-runtime-CLpGMVip.js";const He={title:"Rijkshuisstijl/Checkbox",id:"rhc-checkbox",component:Se,parameters:{status:{type:"STABLE"},docs:{description:{component:Ie([Fe])}},figma:"https://www.figma.com/design/txFX5MGRf4O904dtIFcGTF/NLDS---Rijkshuisstijl---Bibliotheek?node-id=944-1535&node-type=canvas&t=HiNKOQhf1hQtLZrr-0",github:"https://github.com/nl-design-system/rijkshuisstijl-community/issues/462",nldesignsystem:"https://www.nldesignsystem.nl/checkbox/",componentOrigin:"Dit component is overgenomen van de Gemeente Utrecht, met styling van de Rijkshuisstijl Community."},argTypes:{checked:{name:"checked",type:{name:"boolean",required:!1}},onChange:{name:"onChange",type:{name:"function",required:!1}},disabled:{name:"disabled",type:{name:"boolean",required:!1}},value:{name:"value",type:{name:"string",required:!1}},"aria-label":{name:"aria-label",type:{name:"string",required:!0}}},args:{"aria-label":"checkbox-label"}},e={},r={parameters:{pseudo:{active:!0}}},s={parameters:{pseudo:{hover:!0}}},a={parameters:{pseudo:{focus:!0}}},n={parameters:{pseudo:{focusVisible:!0}}},t={args:{disabled:!0}},o={args:{invalid:!0}},c={args:{checked:!0,onChange:()=>{}}},d={args:{checked:!0,onChange:()=>{}},parameters:{pseudo:{active:!0}}},u={args:{checked:!0,onChange:()=>{}},parameters:{pseudo:{hover:!0}}},i={args:{checked:!0,onChange:()=>{}},parameters:{pseudo:{focus:!0}}},m={args:{checked:!0,onChange:()=>{}},parameters:{pseudo:{focusVisible:!0},controls:{exclude:["appearance"]}}},p={args:{checked:!0,onChange:()=>{},disabled:!0}},l={args:{indeterminate:!0}},g={args:{indeterminate:!0},parameters:{pseudo:{active:!0}}},h={args:{indeterminate:!0},parameters:{pseudo:{hover:!0}}},b={args:{indeterminate:!0},parameters:{pseudo:{focus:!0}}},k={args:{indeterminate:!0},parameters:{pseudo:{focusVisible:!0,focus:!0}}},v={args:{indeterminate:!0,disabled:!0}};var f,C,A;e.parameters={...e.parameters,docs:{...(f=e.parameters)==null?void 0:f.docs,source:{originalSource:"{}",...(A=(C=e.parameters)==null?void 0:C.docs)==null?void 0:A.source}}};var S,F,I;r.parameters={...r.parameters,docs:{...(S=r.parameters)==null?void 0:S.docs,source:{originalSource:`{
  parameters: {
    pseudo: {
      active: true
    }
  }
}`,...(I=(F=r.parameters)==null?void 0:F.docs)==null?void 0:I.source}}};var y,V,x;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
  parameters: {
    pseudo: {
      hover: true
    }
  }
}`,...(x=(V=s.parameters)==null?void 0:V.docs)==null?void 0:x.source}}};var D,j,w;a.parameters={...a.parameters,docs:{...(D=a.parameters)==null?void 0:D.docs,source:{originalSource:`{
  parameters: {
    pseudo: {
      focus: true
    }
  }
}`,...(w=(j=a.parameters)==null?void 0:j.docs)==null?void 0:w.source}}};var H,q,O;n.parameters={...n.parameters,docs:{...(H=n.parameters)==null?void 0:H.docs,source:{originalSource:`{
  parameters: {
    pseudo: {
      focusVisible: true
    }
  }
}`,...(O=(q=n.parameters)==null?void 0:q.docs)==null?void 0:O.source}}};var R,G,L;t.parameters={...t.parameters,docs:{...(R=t.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    disabled: true
  }
...
}`,...(Q=(N=c.parameters)==null?void 0:N.docs)==null?void 0:Q.source}}};var _,K,U;d.parameters={...d.parameters,docs:{...(_=d.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    checked: true,
    onChange: () => {}
  },
...
}`,...(U=(K=d.parameters)==null?void 0:K.docs)==null?void 0:U.source}}};var X,Z,$;u.parameters={...u.parameters,docs:{...(X=u.parameters)==null?void 0:X.docs,source:{originalSource:`{
  args: {
    checked: true,
    onChange: () => {}
  },
...
}`,...(he=(ge=b.parameters)==null?void 0:ge.docs)==null?void 0:he.source}}};var be,ke,ve;k.parameters={...k.parameters,docs:{...(be=k.parameters)==null?void 0:be.docs,source:{originalSource:`{
  args: {
    indeterminate: true
  },
  parameters: {
...
}`,...(ve=(ke=k.parameters)==null?void 0:ke.docs)==null?void 0:ve.source}}};var fe,Ce,Ae;v.parameters={...v.parameters,docs:{...(fe=v.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  args: {
    indeterminate: true,
    disabled: true
  }
}`,...(Ae=(Ce=v.parameters)==null?void 0:Ce.docs)==null?void 0:Ae.source}}};const qe=["Default","Active","Hover","Focus","FocusVisible","Disabled","Invalid","Checked","CheckedAndActive","CheckedAndHover","CheckedAndFocus","CheckedAndFocusVisible","CheckedAndDisabled","Indeterminate","IndeterminateAndActive","IndeterminateAndHover","IndeterminateAndFocus","IndeterminateAndFocusVisible","IndeterminateAndDisabled"];export{r as Active,c as Checked,d as CheckedAndActive,p as CheckedAndDisabled,i as CheckedAndFocus,m as CheckedAndFocusVisible,u as CheckedAndHover,e as Default,t as Disabled,a as Focus,n as FocusVisible,s as Hover,l as Indeterminate,g as IndeterminateAndActive,v as IndeterminateAndDisabled,b as IndeterminateAndFocus,k as IndeterminateAndFocusVisible,h as IndeterminateAndHover,o as Invalid,qe as __namedExportsOrder,He as default};
