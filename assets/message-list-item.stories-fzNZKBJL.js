import{j as a}from"./jsx-runtime-BlAj40OV.js";import{M as r,r as h}from"./index.esm-BQdhOdHZ.js";import"./index-Cs7sjTYM.js";import"./_commonjsHelpers-BosuxZz1.js";/* empty css              */import"./index.esm-DN4TXdWq.js";import"./objectWithoutProperties-BJfzkg-c.js";import"./extends-CF3RwP-h.js";const L=`<!-- @license CC0-1.0 -->
...
\`\`\`
`,k={title:"Rijkshuisstijl/Message List/Message List Item",id:"rhc-message-list-item",component:r,args:{description:"Description",href:"#",label:"Label",metaData:"Meta Data"},argTypes:{description:{description:"Description",control:"text",table:{category:"API"}},href:{description:"Target URL",control:"text",table:{category:"API"}},label:{description:"Label",control:"text",table:{category:"API"}},metaData:{description:"Meta data",control:"text",table:{category:"API"}}},parameters:{docs:{description:{component:L}}},render:g=>a.jsx(h,{children:a.jsx(r,{...g})}),tags:["autodocs"]},e={args:{description:"Description",href:"#",label:"Label",metaData:"Meta Data"}},t={parameters:{pseudo:{hover:!0}}},s={parameters:{pseudo:{focus:!0}}};var o,i,n;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
...
}`,...(u=(l=s.parameters)==null?void 0:l.docs)==null?void 0:u.source}}};const v=["Default","Hover","Focus"];export{e as Default,s as Focus,t as Hover,v as __namedExportsOrder,k as default};
