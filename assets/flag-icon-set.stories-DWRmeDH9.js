import{j as o}from"./iframe-CLJWzYSL.js";/* empty css              */import{i as c}from"./icon-set-BOITYAS1.js";import{H as d}from"./Heading-DtKKvk0f.js";import{I as l,r as u}from"./Icon-jj8y1g7G.js";import{m as g}from"./merge-markdown-D8Eslh9D.js";import"./preload-helper-Dp1pzeXC.js";import"./index-GfqW3cb2.js";import"./IconCheck-NNwnFqFE.js";u(c);function a(){const i=new Intl.DisplayNames(["nl"],{type:"region"}),m=Object.keys(c).sort((e,p)=>e.localeCompare(p));return o.jsx("div",{className:"rhc-icon-set",children:m.map(e=>o.jsxs("div",{className:"rhc-icon-set-item",children:[o.jsx(d,{appearanceLevel:5,level:1,children:i.of(e.substring(0,2).toUpperCase())}),o.jsx(l,{icon:e}),o.jsx("span",{children:e})]},e))})}a.__docgenInfo={description:"",methods:[],displayName:"IconSet"};const f=`# Rijkshuisstijl Community Flag Icon Set
