import{j as a}from"./jsx-runtime-BlAj40OV.js";import{B as p,j as t}from"./index.esm-DN4TXdWq.js";import"./index-Cs7sjTYM.js";import"./_commonjsHelpers-BosuxZz1.js";import"./objectWithoutProperties-BJfzkg-c.js";import"./extends-CF3RwP-h.js";const m=`<!-- @license CC0-1.0 -->
...
`,h={title:"Rijkshuisstijl/ActionGroup",id:"rhc-action-group",component:p,argTypes:{direction:{description:"Layout of the action group",control:"select",options:["column","row"]}},tags:["autodocs"],parameters:{status:{type:"STABLE"},docs:{description:{component:m}}}},n={args:{children:[a.jsx(t,{appearance:"primary-action-button",children:"Save and continue"}),a.jsx(t,{appearance:"secondary-action-button",children:"Back"})]},name:"Default"},e={args:{direction:"column",children:[a.jsx(t,{appearance:"primary-action-button",children:"Save and continue"}),a.jsx(t,{appearance:"secondary-action-button",children:"Back"})]},name:"Column"};var o,r,i;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:`{
  ...
  name: 'Column'
}`,...(u=(c=e.parameters)==null?void 0:c.docs)==null?void 0:u.source}}};const j=["Default","Column"];export{e as Column,n as Default,j as __namedExportsOrder,h as default};
