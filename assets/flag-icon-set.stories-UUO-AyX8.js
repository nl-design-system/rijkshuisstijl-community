import{m as d}from"./mergeMarkdown-B56Gr9e6.js";import{j as o}from"./iframe-CYk8V2d0.js";/* empty css              */import{i as c}from"./icon-set-mdOPojMK.js";import{H as l}from"./Heading-DF8K3Gmo.js";import{I as u,r as g}from"./Icon-UngLak5Y.js";import"./preload-helper-Dp1pzeXC.js";import"./index-DwYygznx.js";import"./IconCheck-DhxAl1tC.js";g(c);function a(){const i=new Intl.DisplayNames(["nl"],{type:"region"}),m=Object.keys(c).sort((e,p)=>e.localeCompare(p));return o.jsx("div",{className:"rhc-icon-set",children:m.map(e=>o.jsxs("div",{className:"rhc-icon-set-item",children:[o.jsx(l,{appearanceLevel:5,level:1,children:i.of(e.substring(0,2).toUpperCase())}),o.jsx(u,{icon:e}),o.jsx("span",{children:e})]},e))})}a.__docgenInfo={description:"",methods:[],displayName:"IconSet"};const f=`# Rijkshuisstijl Community Flag Icon Set
