import{c as l}from"./TwigRenderer-CpH3w1yf.js";import{m as d}from"./merge-markdown-BtgmYwh_.js";import"./jsx-runtime-CLpGMVip.js";import"./_commonjsHelpers-C932wzq6.js";const m=`{% from "attributes.twig" import parse_attributes %}
...
\`\`\`
`;/* @license CC0-1.0 */const r=Object.values(p),g=l(m),v={title:"Twig Components/Icon",id:"rhc-twig-icon",component:g,argTypes:{icon:{options:r,control:{type:"select",labels:r}}},parameters:{docs:{description:{component:d([u])}},status:{type:"STABLE"}}},e={args:{icon:"home"},name:"Home"},n={args:{icon:"brand-x"},name:"Custom icon"};var t,o,i;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {
    icon: 'home'
  },
  name: 'Home'
  ...
  name: 'Custom icon'
}`,...(c=(s=n.parameters)==null?void 0:s.docs)==null?void 0:c.source}}};const f=["Default","CustomIcon"];export{n as CustomIcon,e as Default,f as __namedExportsOrder,v as default};
