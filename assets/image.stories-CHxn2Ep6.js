import{i as r}from"./index.esm-r8czDcbn.js";import{m as i}from"./merge-markdown-BtgmYwh_.js";/* empty css              */import"./index-Dl4KGgVD.js";import"./objectWithoutProperties-CbCxjZzm.js";import"./index-DAIO8Scy.js";import"./_commonjsHelpers-C932wzq6.js";import"./jsx-runtime-CLpGMVip.js";import"./clsx-B-dksMZM.js";import"./index-D5-rbeG3.js";const a=`<!-- @license CC0-1.0 -->
...
`,G={title:"Rijkshuisstijl/Image",id:"rhc-image",component:r,argTypes:{src:{description:"Image source",control:{type:"text"},table:{category:"Property"}},alt:{description:"Image alt text",control:{type:"text"},table:{category:"Property"}},width:{description:"Image width",control:{type:"number"},table:{category:"Property"}},height:{description:"Image height",control:{type:"number"},table:{category:"Property"}}},tags:["autodocs"],parameters:{status:{type:"STABLE"},docs:{description:{component:i([a,c,s,l])}},componentOrigin:"Dit component is overgenomen van de Gemeente Utrecht, maar de photo property altijd geset, daardoor is hij altijd max-height en max-width 100%."}},e={args:{alt:"Multicolored tulip field",height:763,width:640,src:"./placeholder.jpg"},name:"Image"};var t,o,n;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  ...
  name: 'Image'
}`,...(n=(o=e.parameters)==null?void 0:o.docs)==null?void 0:n.source}}};const k=["Default"];export{e as Default,k as __namedExportsOrder,G as default};
