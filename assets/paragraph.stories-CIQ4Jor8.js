import{m as l}from"./merge-markdown-BtgmYwh_.js";import{P as d}from"./paragraph-Bm2wF22U.js";import"./_commonjsHelpers-C932wzq6.js";import"./objectWithoutProperties-CbCxjZzm.js";import"./jsx-runtime-CLpGMVip.js";import"./clsx-B-dksMZM.js";import"./index-DAIO8Scy.js";const p=`<!-- @license CC0-1.0 -->
...
`;/* @license CC0-1.0 */const b={title:"Rijkshuisstijl/Paragraph",id:"rhc-paragraph",component:d,argTypes:{purpose:{description:"Lead paragraph",control:{type:"select"},options:[void 0,"lead"],table:{category:"API"},defaultValue:!1},small:{description:"Small paragraph",type:{name:"boolean"},table:{category:"API"}},children:{description:"Paragraph text - default webcomponent slot",type:{name:"string",required:!0},table:{category:"Webcomponent Slot"},defaultValue:""}},args:{children:""},tags:["autodocs"],parameters:{status:{type:"STABLE"},docs:{description:{component:l([p])}},componentOrigin:"Dit component is overgenomen van de Gemeente Utrecht, met alleen overgeschreven design tokens van de Rijkshuisstijl Community."}},e={args:{children:"Lorem ipsum dolor sit amet, consectetur ad isicing elit, sed do eiusmod"},name:"Paragraph"},n={args:{children:"Lorem ipsum dolor sit amet, consectetur ad isicing elit, sed do eiusmod",purpose:"lead"}};var a,t,r;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
  args: {
    children: 'Lorem ipsum dolor sit amet, consectetur ad isicing elit, sed do eiusmod'
  },
  name: 'Paragraph'
}`,...(r=(t=e.parameters)==null?void 0:t.docs)==null?void 0:r.source}}};var o,i,s;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    children: 'Lorem ipsum dolor sit amet, consectetur ad isicing elit, sed do eiusmod',
    purpose: 'lead'
  }
}`,...(s=(i=n.parameters)==null?void 0:i.docs)==null?void 0:s.source}}};const w=["Default","Lead"];export{e as Default,n as Lead,w as __namedExportsOrder,b as default};
