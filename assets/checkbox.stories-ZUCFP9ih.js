import{m as Ne}from"./merge-markdown-CQvfZ6M6.js";import{j as Oe}from"./jsx-runtime-D_zvdyIk.js";import{r as o}from"./index-C5EOLjWw.js";import"./_commonjsHelpers-C932wzq6.js";function we(r){var a,s,e="";if(typeof r=="string"||typeof r=="number")e+=r;else if(typeof r=="object")if(Array.isArray(r)){var n=r.length;for(a=0;a<n;a++)r[a]&&(s=we(r[a]))&&(e&&(e+=" "),e+=s)}else for(s in r)r[s]&&(e&&(e+=" "),e+=s);return e}function Ge(){for(var r,a,s=0,e="",n=arguments.length;s<n;s++)(r=arguments[s])&&(a=we(r))&&(e&&(e+=" "),e+=a);return e}const He=o.forwardRef(({appearance:r="custom",disabled:a,indeterminate:s=!1,inputRequired:e,invalid:n,required:I,className:Re,...Ee},qe)=>{let t=o.useRef(null);return o.useImperativeHandle(qe,()=>t.current),o.useEffect(()=>{t.current&&(t.current.indeterminate=s)},[s]),Oe.jsx("input",{...Ee,ref:t,type:"checkbox",className:Ge("utrecht-checkbox","utrecht-checkbox--html-input",{"utrecht-checkbox--disabled":a,"utrecht-checkbox--custom":r==="custom","utrecht-checkbox--invalid":n,"utrecht-checkbox--indeterminate":s,"utrecht-checkbox--required":I||e},Re),"aria-checked":s?"mixed":void 0,"aria-invalid":n||void 0,"aria-required":I||void 0,disabled:a,required:e})});He.displayName="Checkbox";const Le=`<!-- @license CC0-1.0 -->
...
}`,...($=(Y=g.parameters)==null?void 0:Y.docs)==null?void 0:$.source}}};var ee,re,se;k.parameters={...k.parameters,docs:{...(ee=k.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  args: {
    checked: true,
    onChange: () => {}
  },
...
}`,...(se=(re=k.parameters)==null?void 0:re.docs)==null?void 0:se.source}}};var ae,ne,te;b.parameters={...b.parameters,docs:{...(ae=b.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  args: {
    checked: true,
    onChange: () => {}
  },
...
}`,...(te=(ne=b.parameters)==null?void 0:ne.docs)==null?void 0:te.source}}};var oe,ce,ue;f.parameters={...f.parameters,docs:{...(oe=f.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  args: {
    checked: true,
    onChange: () => {}
  },
...
}`,...(he=(le=C.parameters)==null?void 0:le.docs)==null?void 0:he.source}}};var ge,ke,be;x.parameters={...x.parameters,docs:{...(ge=x.parameters)==null?void 0:ge.docs,source:{originalSource:`{
  args: {
    indeterminate: true
  },
  parameters: {
...
}`,...(be=(ke=x.parameters)==null?void 0:ke.docs)==null?void 0:be.source}}};var fe,ve,Ce;A.parameters={...A.parameters,docs:{...(fe=A.parameters)==null?void 0:fe.docs,source:{originalSource:`{
  args: {
    indeterminate: true
  },
  parameters: {
