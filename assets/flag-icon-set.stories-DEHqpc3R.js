import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{H as p,I as l,r as u}from"./index.esm-DXdSxwZF.js";import{i as c}from"./icon-set-CEqqac1X.js";import{P as g}from"./index-C8tyil2Q.js";/* empty css              */import{m as f}from"./merge-markdown-566X0PcZ.js";import"./index-F0AouRE7.js";import"./_commonjsHelpers-D6-XlEtG.js";u(c);function i(){const a=new Intl.DisplayNames(["nl"],{type:"region"}),m=Object.keys(c).sort((e,d)=>e.localeCompare(d));return o.jsx(g,{children:o.jsx("div",{className:"rhc-icon-set",children:m.map(e=>o.jsxs("div",{className:"rhc-icon-set-item",children:[o.jsx(p,{appearanceLevel:5,level:1,children:a.of(e.substring(0,2).toUpperCase())}),o.jsx(l,{icon:e}),o.jsx("span",{children:e})]},e))})})}i.__docgenInfo={description:"",methods:[],displayName:"IconSet"};const h=`# Rijkshuisstijl Community Flag Icon Set
