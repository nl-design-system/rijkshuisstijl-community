import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{as as a,H as p,I as l,r as u}from"./index.esm-Q1rCYN5A.js";import{P as g}from"./index-CO3dtgAk.js";/* empty css              */import{m as h}from"./merge-markdown-566X0PcZ.js";import"./index-DeTAkU8q.js";import"./_commonjsHelpers-D6-XlEtG.js";u(a);function c(){const i=new Intl.DisplayNames(["nl"],{type:"region"}),m=Object.keys(a).sort((e,d)=>e.localeCompare(d));return o.jsx(g,{children:o.jsx("div",{className:"rhc-icon-set",children:m.map(e=>o.jsxs("div",{className:"rhc-icon-set-item",children:[o.jsx(p,{appearanceLevel:5,level:1,children:i.of(e.substring(0,2).toUpperCase())}),o.jsx(l,{icon:e}),o.jsx("span",{children:e})]},e))})})}c.__docgenInfo={description:"",methods:[],displayName:"IconSet"};const j=`# Rijkshuisstijl Community Flag Icon Set
