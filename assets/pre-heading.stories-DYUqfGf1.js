import{j as n}from"./iframe-CYk8V2d0.js";import{m}from"./mergeMarkdown-B56Gr9e6.js";import{V as p}from"./index-DwYygznx.js";import{H as c}from"./Heading-DF8K3Gmo.js";import"./preload-helper-Dp1pzeXC.js";const a=({ref:s,children:o,heading:d,...g})=>n.jsxs("div",{className:"rhc-heading-container",...g,children:[d,n.jsx(p,{className:"rhc-pre-heading",ref:s,children:o})]});a.displayName="PreHeading";a.__docgenInfo={description:"",methods:[],displayName:"PreHeading",props:{heading:{required:!0,tsType:{name:"ReactElement",elements:[{name:"HeadingProps"}],raw:"ReactElement<HeadingProps>"},description:""},ref:{required:!1,tsType:{name:"Ref",elements:[{name:"HTMLParagraphElement"}],raw:"Ref<HTMLParagraphElement>"},description:""}},composes:["UtrechtPreHeadingProps"]};const h=`<!-- @license CC0-1.0 -->
