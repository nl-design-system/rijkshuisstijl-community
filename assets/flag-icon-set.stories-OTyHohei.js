import{j as o}from"./jsx-runtime-CLpGMVip.js";import{H as p,I as l,r as u}from"./index.esm-CU9AM1Y_.js";import{i as c}from"./icon-set-H98LQYBj.js";import{P as g}from"./index-D2H8BgcE.js";/* empty css              */import{m as f}from"./merge-markdown-BBBI8PmH.js";import"./index-BBVzVmym.js";import"./_commonjsHelpers-BosuxZz1.js";u(c);function i(){const a=new Intl.DisplayNames(["nl"],{type:"region"}),m=Object.keys(c).sort((e,d)=>e.localeCompare(d));return o.jsx(g,{children:o.jsx("div",{className:"rhc-icon-set",children:m.map(e=>o.jsxs("div",{className:"rhc-icon-set-item",children:[o.jsx(p,{appearanceLevel:5,level:1,children:a.of(e.substring(0,2).toUpperCase())}),o.jsx(l,{icon:e}),o.jsx("span",{children:e})]},e))})})}i.__docgenInfo={description:"",methods:[],displayName:"IconSet"};const h=`# Rijkshuisstijl Community Flag Icon Set
