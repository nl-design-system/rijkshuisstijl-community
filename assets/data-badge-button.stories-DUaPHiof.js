import{j as e}from"./iframe-DjDDBvOj.js";import{m as F}from"./merge-markdown-BK17y5gr.js";import{D as t}from"./DataBadgeButton-D0IvwUhy.js";import{I as c}from"./IconCheck-CmixPAhC.js";import"./preload-helper-Dp1pzeXC.js";import"./index-gh1d-vat.js";const H=`<!-- @license CC0-1.0 -->
...
`,l=z=>e.jsx(t,{...z}),J={title:"Data Badge Button",id:"rhc-data-badge-button",component:l,argTypes:{children:{description:"Data Badge Button text content",type:{name:"string",required:!0},table:{category:"Content"},defaultValue:"Label"},pressed:{description:"Of de Data Badge Button pressed/actief is",type:{name:"boolean"},table:{category:"Props"},defaultValue:!1},icon:{description:"Icon om in de Data Badge Button te plaatsen",control:!1,table:{category:"Props"}},iconAlign:{description:"Icon positie - voor of na de tekst (alleen relevant wanneer Icon gebruikt wordt)",control:{type:"select"},options:["start","end"],table:{category:"Props"}},helperText:{description:"Toegankelijke helper tekst voor screen readers",type:{name:"string"}}},args:{children:"Filter Label",pressed:!1},tags:["autodocs"],parameters:{status:{type:"UNSTABLE"},docs:{description:{component:F([H])}},github:"https://github.com/nl-design-system/rijkshuisstijl-community/blob/main/packages/components-react/src/DataBadgeButton.tsx"},render:l},n={args:{children:"Filter Label"}},a={args:{children:"With Icon Before",pressed:!0,icon:e.jsx(c,{}),iconAlign:"start"}},r={args:{children:"With Icon After",pressed:!0,icon:e.jsx(c,{}),iconAlign:"end"}},o={args:{children:"Category",helperText:"Klik om te filteren op categorie"}},s={args:{children:"With Focus"},parameters:{pseudo:{focusVisible:!0}}},i={args:{children:"Hover State"},parameters:{pseudo:{hover:!0}}},d={render:()=>e.jsxs("div",{style:{display:"flex",gap:"8px",flexWrap:"wrap"},children:[e.jsx(t,{children:"All Items"}),e.jsx(t,{children:"Videos "}),e.jsx(t,{pressed:!0,icon:e.jsx(c,{}),children:"Documents"}),e.jsx(t,{children:"Images"}),e.jsx(t,{helperText:"Filter op recente uploads"})]})};var p,u,g;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
